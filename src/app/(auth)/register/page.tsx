...
const roles = [
  { href: '/register/mahasiswa', label: 'Mahasiswa', desc: 'Daftar sebagai mahasiswa untuk mulai bimbingan', icon: (
  ...
  { href: '/register/dosen', label: 'Dosen', desc: 'Daftar sebagai dosen untuk mengelola bimbingan', icon: (
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 py-12">
      <div className="w-full max-w-3xl">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 mb-3 tracking-tight">Daftar Akun Baru</h1>
          <p className="text-gray-500 text-lg">Pilih tipe akun dan lengkapi profil Anda</p>
        </div>
